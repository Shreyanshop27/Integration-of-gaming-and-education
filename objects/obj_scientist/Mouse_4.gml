...
if(science_Var == 1)
{
	...
	/// @DnDArgument : "ypos" "-30"
	/// @DnDArgument : "ypos_relative" "1"
	/// @DnDArgument : "objectid" "dia_scientist2"
	/// @DnDArgument : "layer" ""object""
	/// @DnDSaveInfo : "objectid" "dia_scientist2"
	instance_create_layer(x + 0, y + -30, "object", dia_scientist2);

	/// @DnDAction : YoYo Games.Files.File_Rename
	/// @DnDVersion : 1
	/// @DnDHash : 1707175D
	/// @DnDParent : 436E0503
	/// @DnDArgument : "file1" ""doorbg.jpg""
	file_rename("doorbg.jpg", "newfile.txt");
